export const meta = {
  name: "field-guide-r4",
  description: "soulbis⊥soulbae dual-agent harness round on field-guide-r4 (Measure → Propose → Hold-apart → Assay → Critic → Chronicle)",
  phases: [
...
// GENERATED by tools/bundle.mjs from examples/field-guide/harness.r4.config.mjs — do not hand-edit; edit the config and rebundle.
