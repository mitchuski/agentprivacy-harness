export const meta = {
  name: "field-guide-r3",
  description: "soulbis⊥soulbae dual-agent harness round on field-guide-r3 (Measure → Propose → Hold-apart → Assay → Critic → Chronicle)",
  phases: [
...
// GENERATED by tools/bundle.mjs from examples/field-guide/harness.r3.config.mjs — do not hand-edit; edit the config and rebundle.
